...
Install the cobra generator with the command `go install github.com/bketelsen/sc-cli@latest`. 
...
cobra-cli init can also be run from a subdirectory such as how the [cobra generator itself is organized](https://github.com/bketelsen/sc-cli).
...
For complete details on using the Cobra library, please read the [The Cobra User Guide](https://github.com/bketelsen/sc/blob/main/site/content/user_guide.md#using-the-cobra-library).
