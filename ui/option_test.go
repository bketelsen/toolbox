...
// Tests for option.go require a real terminal and interactive input via huh v2.
// The Option() function directly calls huh.NewSelect().Run() which blocks on terminal I/O
...
//
// The Option function is a thin wrapper around huh's selection prompt and has no
